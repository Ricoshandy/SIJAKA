...
class FormLektorAgamaSeeder extends Seeder
{
    public function run(): void
    {
        $lektor_agama = FormPengajuan::where([
                ['rumpun', '=', 'AGAMA'],
                ['usul', '=', 'LEKTOR']
            ])->first();
        ...
        $data_lektor_agama = [
            [
                'id' => Str::uuid(),
                'form_pengajuan_id' => $lektor_agama->id,
            ...
            [
                ...
                'key' => 'sk_pns',
                'title' => 'Scan SK PNS',
                'description' => 'SK PNS / SK Inpassing gol. III/b bagi DTNPNS*',
                'detail' => null,
                'order' => 4,
            ],
            [
            ...
            [
                ...
                'description' => 'SK PAK Konversi (dari e-kinerja) dengan keterangan bahwa dapat dinaikkan dalam jenjang jabatan Muda',
                'detail' => null,
                'order' => 6,
            ],
            [
        ...
        FormPengajuanDetail::insert($data_lektor_agama);
